...
class MQTT {
    ...
    constructor(api) {
        ...
        this.dispatchMuteEvent(this.#api.apis.get('/mute').muted);
    }
    ...
    dispatchMuteEvent(muted) {
        let muteStatus = muted ? "on" : "off"
        this.#dispatchInternal(config.mqtt_config.topic + '/muted', muteStatus)
    }
